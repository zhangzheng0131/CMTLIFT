...
class CMT(object):
	...
	#	self.descriptor = cv2.DescriptorExtractor_create(self.DESCRIPTOR)
		self.stimate_scale = True
		self.estimate_rotation = True
	  	print(self.DETECTOR)
		print(self.DESCRIPTOR)
		print(self.MATCHER)
		self.detector = cv2.BRISK_create(20,4,0.8)
		self.descriptor = cv2.BRISK_create(20,4,0.8)
                #self.detector = cv2.BRISK.create(30,3,1.0)
