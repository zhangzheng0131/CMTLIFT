...
CMT.output='/home/zhangzheng/workplace/python+C/CppMT/LIFT-master/CMT/MountaintRolling'
if args.pause:
	pause_time = 0
else:
	pause_time = 10
...
if args.challenge:
	...
	while True:
		...
		cv2.imwrite(str(a)+'.jpg',im_draw)
		#cv2.imwrite("./MountainRolling/"str(a)+'.jpg'"",im_draw)
		a=a+1
